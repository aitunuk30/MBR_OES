...
class ExamController extends Controller
{
    ...
    public function loadExamDashboard($id)
    {
        ...
        if(count($qnaExam) > 0){
            ...
            if($attemptCount >= $qnaExam[0]['attempt']){
                ...
                if(count($qnaExam[0]['getQnaExam']) > 0){
                 ...
                 return view('student.exam-dashboard',['success'=>true,'exam'=>$qnaExam, 'qna' => $qna]);
                      ...
                      return view('student.exam-dashboard',['success'=>false,'msg'=>'This exam not available for now!','exam'=>$qnaExam]);
                }
            ...
            else{ return view('student.exam-dashboard',['success'=>false,'msg'=>'This exam has been expired on '.$qnaExam[0]['date'],'exam'=>$qnaExam]);
